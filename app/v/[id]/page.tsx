...
export default async function Video({ params }: PageProps) {
    ...
    const file = data.result[0];
        ...
        url: `https://bokepdipaksa.pages.dev/v/${file.filecode}#${file.title}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokepdipaksa.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://bokepdipaksa.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://bokepdipaksa.pages.dev/v/${file.filecode}#${file.title}`
            }  
        }
        }
    return (
